<template>
  <div class="card mb-4 mt-5 mx-2">
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <div class="d-flex flex-row  w-50 mt-2 text-center">
                <button type="button" class="btn btn-success float-start" v-if="!upload" @click="deleteOLD">تغییر عکس
                </button>
              </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <div class="d-flex align-items-center">
                <h6 class="mb-0 p-2">متن دکمه اسلاید :</h6>
              </div>
              <input type="text" class="form-control" placeholder=" متن دکمه اسلاید" v-model="button_content">
            </div>
            <div class="mb-3">
              <div class="d-flex align-items-center">
    ...
    <div class="col-6 text-start px-5 py-3 me-auto">
      <vsud-button color="dark" size="lg" data-bs-toggle="modal" data-bs-target="#addSlide" v-if="create">افزودن
        اسلاید
      </vsud-button>
    </div>
          ...
          <tr v-for="(u, i) in slides" :key="i">
            ...
            <td class="align-middle text-center text-sm">
              <vsud-badge color="dark" variant="gradient" size="lg" style="cursor:pointer"
                          ...
                          @click="slideToDel=u;index=i;" v-if="remove">حذف
              </vsud-badge>
              <vsud-badge color="success" variant="gradient" size="lg" style="cursor:pointer"
                          @click="id=u.id;title=u.title;sub_title=u.sub_title;text=u.text;link=u.link;image=u.image;button_content=u.button_content"
  ...
  methods: {
    ...
    async editSlide() {
      ...
      if (update.status === 200) {
        ...
        this.slides[this.index].button_content = this.button_content
      } else {
        this.$notify({
          title: "عملیات ناموفق!",
